...
enum ErrorReason {
	...
	USER_PASSWORD_CANNOT_BE_NULL(3010304, 'password cannot be null'),
	...
	LANGUAGE_PLAG_CONFIG_CANNOT_BE_BLANK(307021, "plagConfig cannot be blank."),

	LANGUAGE_PLAG_CONFIG_TOO_BIG(307022, "{0} does not fall within the valid size range from 1 to 255."),

	LANGUAGE_PLAG_CONFIG_TOO_SMALL(307023, "{0} does not fall within the valid size range from 1 to 255."),

	LANGUAGE_PLAG_CONFIG_CANNOT_BE_NULL(307024, "plagConfig cannot be null."),
